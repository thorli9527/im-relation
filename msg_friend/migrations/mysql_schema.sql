...
CREATE TABLE IF NOT EXISTS `friend_requests` (
  ...
  `from_reason`        VARCHAR(1024) NOT NULL DEFAULT '' COMMENT '申请理由',
  `source`        INT          NOT NULL DEFAULT 0 COMMENT '申请来源(枚举)',
  `from_remark`        VARCHAR(1024) NOT NULL DEFAULT '' COMMENT '申请人留给对方的备注',
  `from_nickname`      VARCHAR(255)  NOT NULL DEFAULT '' COMMENT '申请人希望展示的昵称',
  `to_remark`   VARCHAR(1024) NOT NULL DEFAULT '' COMMENT '对端审批时填写的备注',
  `to_nickname` VARCHAR(255)  NOT NULL DEFAULT '' COMMENT '对端审批时填写的昵称',
