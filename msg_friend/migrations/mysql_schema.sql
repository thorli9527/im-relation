...
CREATE TABLE IF NOT EXISTS `friend_requests` (
  ...
  `remark`        VARCHAR(1024) NOT NULL DEFAULT '' COMMENT '申请人留给对方的备注',
  `nickname`      VARCHAR(255)  NOT NULL DEFAULT '' COMMENT '申请人希望展示的昵称',
  `peer_remark`   VARCHAR(1024) NOT NULL DEFAULT '' COMMENT '对端审批时填写的备注',
  `peer_nickname` VARCHAR(255)  NOT NULL DEFAULT '' COMMENT '对端审批时填写的昵称',
