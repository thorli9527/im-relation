...
impl JoinPermission {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::JoinUnspecified => "JOIN_UNSPECIFIED",
            Self::Anyone => "ANYONE",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "JOIN_UNSPECIFIED" => Some(Self::JoinUnspecified),
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/group_service.GroupService/FindGroupByName" => {
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = FindGroupByNameSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/group_service.GroupService/ChangeNickname" => {
                        ...
                        for ChangeNicknameSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as GroupService>::change_nickname(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ChangeNicknameSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
