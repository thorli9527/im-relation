...
void _deviceProfileSerialize(
  ...
  writer.writeLong(offsets[2], object.deviceType);
...
DeviceProfile _deviceProfileDeserialize(
  ...
  object.deviceType = reader.readLong(offsets[2]);
  object.id = id;
...
extension DeviceProfileQuerySortBy
  ...
  QueryBuilder<DeviceProfile, DeviceProfile, QAfterSortBy> sortByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DeviceProfile, DeviceProfile, QAfterSortBy> sortByDeviceId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DeviceProfile, DeviceProfile, QAfterSortBy> sortByDeviceType() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DeviceProfile, DeviceProfile, QAfterSortBy> sortByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension DeviceProfileQuerySortThenBy
  ...
  QueryBuilder<DeviceProfile, DeviceProfile, QAfterSortBy> thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }
  ...
  QueryBuilder<DeviceProfile, DeviceProfile, QAfterSortBy> thenByDeviceId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deviceId', Sort.asc);
    });
  }
  ...
  QueryBuilder<DeviceProfile, DeviceProfile, QAfterSortBy> thenByDeviceType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deviceType', Sort.asc);
    });
  }
  ...
  QueryBuilder<DeviceProfile, DeviceProfile, QAfterSortBy> thenByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.asc);
    });
  }
...
extension DeviceProfileQueryWhereDistinct
  ...
  QueryBuilder<DeviceProfile, DeviceProfile, QDistinct> distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'createdAt');
    });
  }

  QueryBuilder<DeviceProfile, DeviceProfile, QDistinct> distinctByDeviceId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DeviceProfile, DeviceProfile, QDistinct> distinctByDeviceType() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'deviceType');
    });
  }

  QueryBuilder<DeviceProfile, DeviceProfile, QDistinct> distinctByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension DeviceProfileQueryProperty
  ...
  QueryBuilder<DeviceProfile, DateTime, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createdAt');
    });
  }

  QueryBuilder<DeviceProfile, String, QQueryOperations> deviceIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'deviceId');
    });
  }

  QueryBuilder<DeviceProfile, int, QQueryOperations> deviceTypeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'deviceType');
    });
  }

  QueryBuilder<DeviceProfile, DateTime, QQueryOperations> updatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
