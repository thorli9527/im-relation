...
void _authSessionSerialize(
  ...
  writer.writeLong(offsets[1], object.deviceType);
  writer.writeLong(offsets[2], object.expiresAt);
  writer.writeBool(offsets[3], object.isLoggedIn);
  writer.writeLong(offsets[4], object.loginType);
  writer.writeString(offsets[5], object.password);
  writer.writeString(offsets[6], object.socketAddr);
...
AuthSession _authSessionDeserialize(
  ...
  object.deviceType = reader.readLongOrNull(offsets[1]);
  object.expiresAt = reader.readLongOrNull(offsets[2]);
  object.id = id;
  object.isLoggedIn = reader.readBool(offsets[3]);
  object.loginType = reader.readLongOrNull(offsets[4]);
  object.password = reader.readStringOrNull(offsets[5]);
  object.socketAddr = reader.readStringOrNull(offsets[6]);
...
extension AuthSessionQueryWhere
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension AuthSessionQueryFilter
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterFilterCondition> accountEqualTo(
    String? value, {
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterFilterCondition> accountLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterFilterCondition> accountBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterFilterCondition> accountEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterFilterCondition> accountContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterFilterCondition> accountMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterFilterCondition> passwordEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterFilterCondition> passwordBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterFilterCondition> passwordMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterFilterCondition>
      socketAddrContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'socketAddr',
        value: value,
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterFilterCondition>
      socketAddrMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'socketAddr',
        wildcard: pattern,
...
extension AuthSessionQuerySortBy
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByAccount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'account', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByAccountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'account', Sort.desc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByDeviceType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deviceType', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByDeviceTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deviceType', Sort.desc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByExpiresAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiresAt', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByExpiresAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiresAt', Sort.desc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByIsLoggedIn() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLoggedIn', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByIsLoggedInDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLoggedIn', Sort.desc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByLoginType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'loginType', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByLoginTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'loginType', Sort.desc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByPassword() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'password', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByPasswordDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'password', Sort.desc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortBySocketAddr() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'socketAddr', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortBySocketAddrDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'socketAddr', Sort.desc);
    });
  }
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> sortByUpdatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AuthSessionQuerySortThenBy
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByAccount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'account', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByAccountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'account', Sort.desc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByDeviceType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deviceType', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByDeviceTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deviceType', Sort.desc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByExpiresAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiresAt', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByExpiresAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiresAt', Sort.desc);
    });
  }
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByIsLoggedIn() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLoggedIn', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByIsLoggedInDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLoggedIn', Sort.desc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByLoginType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'loginType', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByLoginTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'loginType', Sort.desc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByPassword() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'password', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByPasswordDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'password', Sort.desc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenBySocketAddr() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'socketAddr', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenBySocketAddrDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'socketAddr', Sort.desc);
    });
  }
  ...
  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.asc);
    });
  }

  QueryBuilder<AuthSession, AuthSession, QAfterSortBy> thenByUpdatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.desc);
    });
  }
...
extension AuthSessionQueryWhereDistinct
  ...
  QueryBuilder<AuthSession, AuthSession, QDistinct> distinctByAccount(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthSession, AuthSession, QDistinct> distinctByDeviceType() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'deviceType');
    });
  }

  QueryBuilder<AuthSession, AuthSession, QDistinct> distinctByExpiresAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'expiresAt');
    });
  }

  QueryBuilder<AuthSession, AuthSession, QDistinct> distinctByIsLoggedIn() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isLoggedIn');
    });
  }

  QueryBuilder<AuthSession, AuthSession, QDistinct> distinctByLoginType() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'loginType');
    });
  }

  QueryBuilder<AuthSession, AuthSession, QDistinct> distinctByPassword(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthSession, AuthSession, QDistinct> distinctBySocketAddr(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'socketAddr', caseSensitive: caseSensitive);
    });
  }
  ...
  QueryBuilder<AuthSession, AuthSession, QDistinct> distinctByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension AuthSessionQueryProperty
  ...
  QueryBuilder<AuthSession, String?, QQueryOperations> accountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'account');
    });
  }

  QueryBuilder<AuthSession, int?, QQueryOperations> deviceTypeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'deviceType');
    });
  }

  QueryBuilder<AuthSession, int?, QQueryOperations> expiresAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'expiresAt');
    });
  }

  QueryBuilder<AuthSession, bool, QQueryOperations> isLoggedInProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isLoggedIn');
    });
  }

  QueryBuilder<AuthSession, int?, QQueryOperations> loginTypeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'loginType');
    });
  }

  QueryBuilder<AuthSession, String?, QQueryOperations> passwordProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'password');
    });
  }

  QueryBuilder<AuthSession, String?, QQueryOperations> socketAddrProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'socketAddr');
    });
  }
  ...
  QueryBuilder<AuthSession, DateTime?, QQueryOperations> updatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
