        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/msg_group_service.GroupMsgService/SendMessage" => {
                    ...
                    impl<T: GroupMsgService> tonic::server::UnaryService<super::Content> for SendMessageSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                ...
                "/msg_group_service.GroupMsgService/ReportMsgRead" => {
                    ...
                    impl<T: GroupMsgService> tonic::server::UnaryService<super::MsgRead> for ReportMsgReadSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                ...
                "/msg_group_service.GroupMsgService/AckMsgDelivered" => {
                    ...
                    impl<T: GroupMsgService> tonic::server::UnaryService<super::MsgDeliveredAck>
                ...
                "/msg_group_service.GroupMsgService/AckMsgRead" => {
                    ...
                    impl<T: GroupMsgService> tonic::server::UnaryService<super::MsgReadAck> for AckMsgReadSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                ...
                "/msg_group_service.GroupMsgService/RecallMsg" => {
                    ...
                    impl<T: GroupMsgService> tonic::server::UnaryService<super::MsgRecall> for RecallMsgSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                ...
                "/msg_group_service.GroupMsgService/ForwardMsg" => {
                    ...
                    impl<T: GroupMsgService> tonic::server::UnaryService<super::MsgForward> for ForwardMsgSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
