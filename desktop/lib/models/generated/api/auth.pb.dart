...
class LoginResponse extends $pb.GeneratedMessage {
  factory LoginResponse({
    ...
    if (socketHost != null) result.socketHost = socketHost;
    if (socketPort != null) result.socketPort = socketPort;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoginResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'api'), createEmptyInstance: create)
    ...
    ..aOS(4, _omitFieldNames ? '' : 'socketHost')
    ..a<$core.int>(5, _omitFieldNames ? '' : 'socketPort', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  /// Socket 对外暴露的主机名/IP。
  @$pb.TagNumber(4)
  $core.String get socketHost => $_getSZ(3);
  @$pb.TagNumber(4)
  set socketHost($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  $core.bool hasSocketHost() => $_has(3);
  @$pb.TagNumber(4)
  void clearSocketHost() => $_clearField(4);

  /// Socket 对外暴露的端口（0 表示使用默认代理端口）。
  @$pb.TagNumber(5)
  $core.int get socketPort => $_getIZ(4);
  @$pb.TagNumber(5)
  set socketPort($core.int value) => $_setUnsignedInt32(4, value);
  @$pb.TagNumber(5)
  $core.bool hasSocketPort() => $_has(4);
  @$pb.TagNumber(5)
  void clearSocketPort() => $_clearField(5);
}
